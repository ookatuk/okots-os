...
pub fn add(id: u8, target: extern "x86-interrupt" fn(InterruptStackFrame), over_write: bool) -> Wirt<&'static mut x86_64::structures::idt::EntryOptions> {
    ...
    Wirt::Ok(unsafe{gs.idt_raw[id].set_handler_fn(target).set_present(true).set_code_selector(SegmentSelector::new(
        1,
